...
export const Resizer = ({ propKey, children, ...props }: any) => {
  ...
  const resizable:any = useRef<Resizable>(null);
  const isResizing:any = useRef<Boolean>(false);
  const editingDimensions:any = useRef<any>(null);
  const nodeDimensions:any = useRef(null);
